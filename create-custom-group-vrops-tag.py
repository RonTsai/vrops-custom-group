...
#         ',"resourceIdentifiers": [],"resourceKindKey":' + '"'+ resourcekindkey + '"' + '}}'
    ...
    # Generating the JSON data
    proReq = '{ "autoResolveMembership": true,"membershipDefinition": { "excludedResources": [],"includedResources": [],"rules": [ { "statConditionRules": [ { "compareOperator": ' \
         '"' + operator + '"' + ',"key":' + '"'+ properties + '"'+ ',"stringValue":' + '"'+ info["tagName"] + '"'+  '}],"relationshipRules": [],"resourceKindKey": \
         { "adapterKind":' + '"'+ adapter + '"' + ',"resourceKind":' + '"'+ resourceknd + '"' + '},"resourceNameConditionRules": []}]},"resourceKey": { "adapterKindKey":' + '"'+ adapterkindkey + '"' + ',"name":' + '"'+ info["tagName"] + '"'+ \
         ',"resourceIdentifiers": [],"resourceKindKey":' + '"'+ resourcekindkey + '"' + '}}'     
